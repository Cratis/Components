...
const matrixCount = inventory.adapters.length * 285 * appearances.length;
console.log(
    `\nCompleted ${inventory.adapters.length} isolated previews × 285 stories × ${appearances.length} appearance mode(s) = ${matrixCount} story/appearance/axe cases.`,
);
