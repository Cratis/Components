...
for (const adapter of inventory.adapters) {
    ...
    if (storyIds.length !== 296 || docsIds.length !== 69) {
        throw new Error(`${adapter.metadata.id} indexed ${storyIds.length} stories and ${docsIds.length} autodocs pages; expected 296 and 69.`);
    }
