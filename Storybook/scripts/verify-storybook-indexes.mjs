...
for (const adapter of inventory.adapters) {
    ...
    if (storyIds.length !== 305 || docsIds.length !== 70) {
        throw new Error(`${adapter.metadata.id} indexed ${storyIds.length} stories and ${docsIds.length} autodocs pages; expected 305 and 70.`);
    }
