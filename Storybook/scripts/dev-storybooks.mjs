...
inventory.adapters.forEach((adapter, index) => launch(
...
console.log(`Composed manager: http://localhost:6006; ${inventory.adapters.length} isolated previews: ports 6100-${6099 + inventory.adapters.length}.`);
