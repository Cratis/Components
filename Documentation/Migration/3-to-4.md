...
For the decision, trade-offs, and validation gates, read [UI foundation](../ui-foundation.md). For the older 2.x → 3.x PrimeReact migration, see [Migrate from Components 2 to 3](2-to-3.md).
