...
This historical guide is preserved for Components 3 consumers. Links to version-specific Components pages use the immutable Components 3 merge commit `080a441` so they cannot drift to Components 4 behavior.
