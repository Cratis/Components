...
### Yarn PnP with Arc React 22.1.0

The current `@cratis/arc.react@22.1.0` package imports `rxjs` without declaring it. A strict Yarn PnP consumer must install `rxjs@7.8.2` and temporarily add this package extension until Arc publishes corrected metadata:

```yaml title=".yarnrc.yml"
packageExtensions:
    '@cratis/arc.react@22.1.0':
        dependencies:
            rxjs: '7.8.2'
```
