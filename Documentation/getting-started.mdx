...
### Yarn PnP with Arc React 22.3.0

The current `@cratis/arc.react@22.3.0` package imports `rxjs` without declaring it. A strict Yarn PnP consumer must install `rxjs@7.8.2` and temporarily add this package extension until Arc publishes corrected metadata:
