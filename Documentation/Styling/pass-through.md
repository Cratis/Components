...
| `NumberInputParts`                            | `root`, `input`, `prefix`, `suffix`, `step`, `description`, `error`                                                                                                                  | owned number-field composition                                |
...
| Basic controls | text inputs and surfaces use `root`; NumberInput uses `root`, `input`, `prefix`, `suffix`, `step`, `description`, `error`; choices use `root`, `input`, `label`, plus `box`/`indicator` or `control`/`handle`                                                                                                                              |
| Dialog         | `backdrop`, `positioner`, `root`, `header`, `title`, `subtitle`, `close`, `content`, `footer`, `confirm`, `cancel`                                                                                                                                                                                                                 |
