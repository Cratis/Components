...
>
    Command dialogs, forms, tables, and application surfaces that consume
    [Arc's](/arc/) generated proxies. Components owns its public contracts,
    semantic parts, and built-in renderer, with optional independently versioned
    MUI and PrimeReact adapters.
</TopicHero>
...
<CardGrid>
    <SimpleCard title='Command input' icon='approve-check' link='/components/commanddialog/'>
...
<CardGrid>
    <SimpleCard title='Components source' icon='seti:folder' link='https://github.com/Cratis/Components'>
