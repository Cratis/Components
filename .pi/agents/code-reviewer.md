...
description: "Quality gate agent for Cratis-based projects. Reviews code against all project instruction files, checking architecture conformance, C# and TypeScript conventions, and vertical slice correctness before merge."
...
<!-- Generated by Cratis/AI tooling/pi-agent-adapters.mjs from .ai/agents/code-reviewer.md; edit the canonical file, then regenerate. -->
