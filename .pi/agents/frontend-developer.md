...
description: "Specialist for TypeScript/React frontend code within a vertical slice. Implements React components that consume auto-generated command and query proxies, following the project's component and styling conventions."
...
<!-- Generated by Cratis/AI tooling/pi-agent-adapters.mjs from .ai/agents/frontend-developer.md; edit the canonical file, then regenerate. -->
...
(If the app has a localization convention, route these labels through it — see [typescript.md](../../.ai/rules/typescript.md). It is product policy, not a Cratis rule.)
