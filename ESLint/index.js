...
const plugin = {
    ...
    rules: {
        ...
        'no-react-in-kernel': noReactInKernel,
    },
    configs: {},
};
...
export { noPrimereactDialog, noRootBarrelImport, onbeforeexecuteMustReturn, noHooksInViewModel, noRawCommandFormMarker, noReactInKernel };
