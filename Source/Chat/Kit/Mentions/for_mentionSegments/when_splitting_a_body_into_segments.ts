...
describe('when the body mentions somebody in the middle', () => {
    ...
    it('should carry the mention with its @', () =>
        segments[1].text.should.equal('@Alice'));
    it('should know who the mention addresses', () =>
        segments[1].mention!.should.equal(alice));
    it('should keep the text after', () =>
        segments[2].text.should.equal(' take a look?'));
...
describe('when the body mentions nobody', () => {
    ...
    it('should carry the whole body', () =>
        segments[0].text.should.equal('all quiet here'));
});
