...
describe('when rendering a body with mentions', () => {
    ...
    it('should render each mention as its own element', () =>
        document
            .querySelectorAll('.cratis-chat-message__mention')
            .should.have.lengthOf(2));

    it('should keep the @ in the mention text', () =>
        document
            .querySelectorAll('.cratis-chat-message__mention')[0]
            .textContent!.should.equal('@Sample User'));
    ...
    it('should mark who a mention addresses', () => {
        document
            ...
            .should.equal('user');
        document
            .querySelectorAll('.cratis-chat-message__mention')[1]
            .getAttribute('data-kind')!
            .should.equal('agent');
    });
    ...
    it('should keep the plain text around the mentions', () =>
        document
            ...
            .textContent!.should.equal(message.body));

    it('should resolve the author through the host', () =>
        document
            .querySelector('.cratis-chat-message__author-name')!
            .textContent!.should.equal('Somebody'));
});
