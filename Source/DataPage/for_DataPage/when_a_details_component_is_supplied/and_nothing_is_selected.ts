...
describe('when a details component is supplied and nothing is selected', () => {
    ...
    it('should not show the details pane', () => {
        (page.container.querySelector('.person-details') === null).should.be.true;
    });
