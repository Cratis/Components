...
describe('when rendered without menu items', () => {
    ...
    it('should leave the action bar out entirely', () => {
        (actionBar(page) === null).should.be.true;
    });

    it('should give the whole column to the table region', () => {
        layoutRootChildren(page).should.deep.equal(['cratis-data-page-table']);
    });
