...
describe('when the last of two steps is undefined and the stepper is on the last rendered step', () => {
    let html: string;
...
describe('when the last of three steps is undefined and the user walks forward', () => {
