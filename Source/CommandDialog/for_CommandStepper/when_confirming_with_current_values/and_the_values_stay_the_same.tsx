...
import { approve, mount, onSuccess, state, submit, unmount } from '../given/a_stepper_with_current_values';

describe('when current values stay the same while a stepper guard is pending', () => {
