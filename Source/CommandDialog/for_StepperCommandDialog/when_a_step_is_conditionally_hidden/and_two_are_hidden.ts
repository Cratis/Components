...
describe('when two of three steps are hidden and the dialog is on the last rendered step', () => {
    let html: string;

    beforeEach(() => {
        html = renderDialog(panel('Step 1'), showOptionalStep && panel('Step 2'), showOptionalStep && panel('Step 3'));
    });
...
describe('when two of four steps are hidden and the dialog is on the first rendered step', () => {
    let html: string;

    beforeEach(() => {
        html = renderDialog(panel('Step 1'), showOptionalStep && panel('Step 2'), panel('Step 3'), showOptionalStep && panel('Step 4'));
    });
