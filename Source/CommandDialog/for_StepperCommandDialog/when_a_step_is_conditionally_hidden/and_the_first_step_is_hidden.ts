...
describe('when the first of two steps is hidden and the dialog is on the last rendered step', () => {
    let html: string;

    beforeEach(() => {
        html = renderDialog(showOptionalStep && panel('Step 1'), panel('Step 2'));
    });
...
describe('when the first of three steps is hidden and the dialog is on the first rendered step', () => {
    let html: string;

    beforeEach(() => {
        html = renderDialog(showOptionalStep && panel('Step 1'), panel('Step 2'), panel('Step 3'));
    });
