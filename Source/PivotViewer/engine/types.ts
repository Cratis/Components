...
export type WorkerInMessage =
    BuildIndexesMessage | ApplyFiltersMessage | ComputeGroupingMessage | SortMessage;

export type WorkerOutMessage =
    IndexesReadyMessage | FilterResultMessage | GroupingResultMessage | SortResultMessage;
