...
describe('when an item is excluded by id', () => {
    ...
    const result = itemsWithinRegion(
        region,
        [
    ...
    it('should not report the excluded item even though its center is within', () =>
        result.should.not.contain('the-region'));
    it('should still report the other contained item', () =>
