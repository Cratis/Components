...
const baselines: Readonly<Record<string, DomBaseline>> = Object.freeze({
    ...
    dropdown: {
        html: '<span class="cratis-dropdown" data-cratis-part="root" data-selected="true"><template></template><div class="cratis-dropdown__select" data-rac=""><button id="react-aria-_R_lH2_" data-cratis-part="trigger" data-selected="true" class="cratis-dropdown__trigger" data-rac="" type="button" tabindex="0" data-react-aria-pressable="true" aria-labelledby="react-aria-_R_lH7_ react-aria-_R_lH3_" aria-describedby="react-aria-_R_lH5_ react-aria-_R_lH6_" aria-haspopup="listbox" aria-expanded="false"><span id="react-aria-_R_lH7_" data-cratis-part="value" data-selected="true" class="cratis-dropdown__value" data-rac="">One</span><span class="cratis-dropdown__indicator" data-cratis-part="indicator" aria-hidden="true">⌄</span></button><div style="border:0;clip:rect(0 0 0 0);clip-path:inset(50%);height:1px;margin:-1px;overflow:hidden;padding:0;position:fixed;width:1px;white-space:nowrap;top:0;left:0" aria-hidden="true" data-react-aria-prevent-focus="true" data-a11y-ignore="aria-hidden-focus" data-testid="hidden-select-container"><label><select tabindex="-1"><option value="" label=" "> </option><option value="string:one:0" selected="">One</option></select></label></div></div></span>',
        tags: {
            button: 1,
            div: 2,
            label: 1,
    ...
    dialog: {
        html: '<div class="cratis-dialog__backdrop" style="z-index:var(--cratis-z-index-dialog)" data-cratis-part="backdrop" data-placement="center" data-open="true"><div class="cratis-dialog__positioner" data-cratis-part="positioner" data-placement="center" data-open="true"><section class="cratis-dialog" style="width:450px" data-cratis-part="root" data-placement="center" data-open="true"><section class="cratis-dialog__document" data-rac="" aria-labelledby="react-aria-_R_5_" role="dialog" tabindex="-1"><header class="cratis-dialog__header" data-cratis-part="header"><h2 id="react-aria-_R_5_" slot="title" data-cratis-part="title" class="cratis-dialog__title">Example dialog</h2><button type="button" class="cratis-dialog__close" data-cratis-part="close" aria-label="Close"><span aria-hidden="true">×</span></button></header><div class="cratis-dialog__content" data-cratis-part="content" data-open="true"><fieldset class="cratis-dialog__busy-scope" data-cratis-part="busy-scope">Dialog content</fieldset></div><footer class="cratis-dialog__footer" data-cratis-part="footer"><fieldset class="cratis-dialog__busy-scope cratis-dialog__busy-scope--footer" data-cratis-part="busy-scope"><button type="button" class="cratis-dialog__button cratis-dialog__button--primary" data-cratis-part="confirm" autofocus=""><span>Ok</span></button><button type="button" class="cratis-dialog__button cratis-dialog__button--secondary" data-cratis-part="cancel"><span>Cancel</span></button></fieldset></footer></section></section></div></div>',
        tags: {
            button: 3,
            div: 3,
            fieldset: 2,
